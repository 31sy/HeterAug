...
def compute_mean_ioU_and_F1(preds, scales, centers, num_classes, datadir, input_size=[473, 473], dataset='val'):
    val_file = os.path.join(datadir, dataset + '_id.txt')
    val_id = [i_id.strip() for i_id in open(val_file)]
    ...
    result_F1 = evaluate_fashion_confusion(confusion_matrix)

    print('==================================================')
    print('Pixel accuracy: %f \n' % result_F1['accuracy'])
    print('Foreground accuracy: %f \n' % result_F1['fg_accuracy'])
    print('average_precision: %f \n' % result_F1['average_precision'])
    print('average_recall: %f \n' % result_F1['average_recall'])
    print('average_f1: %f \n' % result_F1['average_f1'])
    ...
    name_value.append(('Mean accuracy', mean_accuracy))
    name_value.append(('Mean IU', mean_IoU))
    name_value.append(('average_f1', result_F1['average_f1']))
    name_value.append(('average_recall', result_F1['average_recall']))
    name_value.append(('average_precision', result_F1['average_precision']))
    name_value.append(('fg_accuracy', result_F1['fg_accuracy']))
    name_value.append(('accuracy', result_F1['accuracy']))
    name_value = OrderedDict(name_value)
    return name_value
